            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="pt-8 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex gap-6">
                        ...
                        <a href="https://www.linkedin.com/in/social-scale-undefined-6911053a8" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-electric-purple transition-colors"><Linkedin size={20} /></a>
