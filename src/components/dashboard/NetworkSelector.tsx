...
const networks: Network[] = [
    ...
    {
        name: 'TikTok',
        color: 'bg-black border border-slate-200',
    ...
    },
    {
        name: 'Spotify',
        color: 'bg-green-500',
        path: 'M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.66 0 12 0zm5.521 17.34c-.24.359-.66.48-1.021.24-2.82-1.74-6.36-2.101-10.561-1.141-.418.122-.779-.179-.899-.539-.12-.421.18-.78.54-.9 4.56-1.021 8.52-.6 11.64 1.32.42.18.479.659.301 1.02zm1.44-3.3c-.301.42-.841.6-1.262.3-3.239-1.98-8.159-2.58-11.939-1.38-.479.12-1.02-.12-1.14-.6-.12-.48.12-1.021.6-1.141 4.439-1.38 9.9-0.659 13.619 1.62.54.3.6.841.122 1.2zm.12-3.36C15.24 8.4 8.82 8.16 5.16 9.299c-0.6.18-1.2-.181-1.38-.721-.18-.601.18-1.2.72-1.38 4.2-1.26 11.28-1.02 15.421 1.44.54.3.719.96.42 1.501-.3.539-.96.719-1.5.42z'
    },
    {
        name: 'X - Twitter',
        color: 'bg-slate-900',
...
export const NetworkSelector = ({ onSelect }: NetworkSelectorProps) => {
    return (
        <div className="w-full max-w-4xl">
            <h2 className="text-2xl font-bold text-slate-900 mb-6 font-archivo tracking-tight">Select network</h2>
                ...
                {networks.map((network, index) => (
                    ...
                    >
                        <div className="flex items-center gap-4">
                            <div className={`w-10 h-10 rounded-full ${network.color} flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300`}>
