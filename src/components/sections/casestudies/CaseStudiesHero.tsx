...
export const CaseStudiesHero = () => {
  ...
  return (
    <section 
      ref={containerRef} 
      className="relative pt-24 pb-16 md:pt-32 md:pb-20 lg:pt-48 lg:pb-32 overflow-hidden brand-bg min-h-[70vh] md:min-h-[80vh] flex items-center"
    >
      <style>{`
        .brand-bg {
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 w-full text-center">
        ...
        >
          ...
          >
            Empirical <br />
            <span className="text-blue-600 italic">Evidence</span> of Scale.
          </motion.h1>
          ...
          >
            Deep-dive into our deployment logs. Real-world architectural growth 
            benchmarks across the global social ecosystem.
          </motion.p>
          ...
          <motion.div 
            ...
            className="grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 mt-12 pt-12 border-t border-slate-200/60 w-full max-w-3xl mx-auto"
          >
            {[
              { icon: TrendingUp, label: "Growth", val: "Verified" },
              { icon: Activity, label: "Signals", val: "Optimized" },
              { icon: Sparkles, label: "Integrity", val: "Trustless" },
            ].map((stat, i) => (
              <div key={i} className={`flex flex-col items-center gap-2 ${i === 2 ? 'col-span-2 md:col-span-1' : ''}`}>
