...
export const Integrations = () => {
  return (
    <section
      id="start-growing"
      className="py-32 px-6 relative overflow-hidden bg-[#4085FF]"
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10 flex flex-col items-center justify-center min-h-[400px]">
        ...
        <div className="flex flex-col items-center justify-center text-center max-w-4xl mx-auto relative z-20 gap-8">
          ...
          <motion.h2
            ...
            className="font-archivo font-black text-4xl sm:text-6xl md:text-[72px] leading-tight md:leading-[80px] text-white uppercase tracking-tighter"
          >
          ...
          >
            <Button
              size="lg"
              className="bg-white text-blue-600 hover:bg-blue-50 border-none px-8 py-4 rounded-full font-archivo font-bold text-[16px] leading-[22px] shadow-2xl shadow-blue-900/20 transition-all hover:scale-105 active:scale-95"
            >
              Get Started Now <ArrowRight className="ml-2 w-5 h-5" />
            </Button>
            <Button
              size="lg"
              className="bg-transparent text-white border-2 border-white/30 hover:bg-white/10 px-8 py-4 rounded-full font-archivo font-bold text-[16px] leading-[22px] transition-all hover:scale-105 active:scale-95"
            >
